...
// const initialCounterState = { counter: 0, showCounter: true}; //easier to read

// const counterSlice = createSlice({
//     name: "counter", //every slice needs a name(whateverWeWant) as identifier of that piece of state.
//     initialState: initialCounterState, // mandatory as well, but we could just write initialState as this is th same in modern Js
...
//             state.counter = state.counter + action.payload; //action.payload as this is the name react given to the vlue in counter.js
//         },
//         toggleCounter(state) {
...
//     reducer: { counter: counterSlice.reducer, auth: authSlice.reducer }  //counterSlice.reducer // if we would have multiple state slices (bigger app), we would sert an obj with any keys of our choice and the values of those properties would then be different reducer functions.
